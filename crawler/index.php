...
$user_id="inj3ct0r";
 if($user_id) {
      ...
      try {
        ...
        $result = $facebook->api("/Paylasman?fields=name,id,likes,posts.limit(10).fields(caption,type,description,actions,created_time,status_type,likes,comments.fields(from,message,like_count))");     
